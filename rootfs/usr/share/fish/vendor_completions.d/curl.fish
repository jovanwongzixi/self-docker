...
complete --command curl --long-option 'ca-native' --description 'Use CA certificates from the native OS' 
...
complete --command curl --long-option 'haproxy-clientip' --description 'Sets client IP in HAProxy PROXY protocol v1 header' 
...
complete --command curl --long-option 'proxy-ca-native' --description 'Use CA certificates from the native OS for proxy' 
...
complete --command curl --long-option 'ssl-revoke-best-effort' --description 'Ignore missing/offline cert CRL dist points (Schannel)' 
...
complete --command curl --long-option 'trace-config' --description 'Configure which details to log in trace/verbose output' 
complete --command curl --long-option 'trace-ids' --description 'Add transfer and connection identifiers to trace/verbose output' 
